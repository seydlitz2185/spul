...
void err_cont(int, const char *, ...); void err_exit(int, const char *, ...) __attribute__((noreturn));
...
/*
 * apue standard error handler function :err_s,use for userprog
 */
...
void err_quit(const char *fmt, ...) { va_list ap; va_start(ap, fmt); err_doit(0, 0, fmt, ap); va_end(ap); exit(1); } 
/*
...
static void err_doit(int errnoflag, int error, const char *fmt, va_list ap) { 
	...
	fputs(buf, stderr); fflush(NULL); /* flushes all stdio output streams */ 
}
